...
export const Apresentacao = () => {
  ...
  return (
    <div className="dark:text-neutral-100 grid grid-cols-1 grid-rows-1 sm:grid-cols-2 sm:grid-rows-2 lg:gap-x-24 gap-x-8 sm:gap-x-18 mx-8 md:mx-24 sm:mr-24 my-14 bg-neutral-100 dark:bg-neutral-800 rounded-lg">
      <div className="flex flex-col gap-2 col-start-1 col-end-2 row-start-1 row-end-2 p-4">
        <h2 className="text-4xl sm:text-4xl md:text-3xl lg:text-4xl xl:text-6xl font-[inconsolata] opacity-80">
          hello, world
        </h2>
        <h4 className="text-xs sm:text-sm  lg:text-base xs:text-lg font-[metropolislight]">
          Meu nome é Alexandre Figueiredo Gomes. Sou um desenvolvedor{" "}
          <span className="font-[metropolisbold] dark:text-white">front end</span> (estudando
