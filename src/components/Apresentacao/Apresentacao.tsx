...
export const Apresentacao = () => {
  ...
  return (
    <div className="dark:text-stone-100 grid grid-cols-1 grid-rows-1 sm:grid-cols-2 sm:grid-rows-2 lg:gap-x-24 gap-x-8 sm:gap-x-18 mx-8 md:mx-24 sm:mr-24 my-14 bg-neutral-100 dark:bg-neutral-800 rounded-lg">
      <div className="flex flex-col gap-2 col-start-1 col-end-2 row-start-1 row-end-2 p-4">
        ...
        <h4 className="text-xs sm:text-sm  xs:text-lg font-[metropolislight]">
          ...
          <span className="font-[metropolisbold] dark:text-stone-50">front end</span> (estudando
