export const Footer = () => {
  return (
    <footer className="dark:bg-neutral-900 bg-neutral-200 dark:text-neutral-200 h-20  md:h-16 flex flex-col md:flex-row justify-end gap-2 pt-4 md:pt-0 pr-20 md:pr-32 items-end md:items-center">
