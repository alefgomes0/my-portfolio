...
export const IconesTecnologia = (props: IconesTecnologiaProps) => {
  ...
  return (
    <div className="flex flex-col gap-2 md:gap-8 row-start-2 row-end-3 p-4 opacity-80">
      ...
      <div className="grid auto-rows-min grid-cols-[60px_60px_60px_60px] md:grid-cols-[85px_85px_85px] lg:grid-cols-[85px_85px_85px_85px_85px] gap-2 md:gap-4">
        <svg
        ...
        >
          <path
            className="transition-colors duration-200 ease-in-out"
            fill={`${hoveredIcon === 6 ? "#83CD29" : "currentColor"}`}
        ...
        >
          <path
            className="transition-colors duration-200 ease-in-out"
            fill={`${hoveredIcon === 7 ? "currentColor" : "currentColor"}`}
        ...
        >
          <path
            className="transition-colors duration-200 ease-in-out"
            fill={`${hoveredIcon === 8 ? "#F34F29" : "currentColor"}`}
        ...
        >
          <path
            className="transition-colors duration-200 ease-in-out"
            fill={`${hoveredIcon === 9 ? "#99425B" : "currentColor"}`}
        ...
        >
          <path
            className="transition-colors duration-200 ease-in-out"
            fill={`${hoveredIcon === 10 ? "#99425B" : "currentColor"}`}
