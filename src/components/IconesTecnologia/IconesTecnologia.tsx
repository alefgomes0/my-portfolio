...
export const IconesTecnologia = () => {
  ...
  return (
    <div className="flex flex-col gap-2 md:gap-8 row-start-2 row-end-3 p-4">
      <h2 className="text-4xl sm:text-4xl md:text-6xl font-[metropolisregular] opacity-80">
        TECNOLOGIAS
      </h2>
      <div className="flex gap-2 md:gap-4 ">
        ...
        >
          <path
            className="transition-colors duration-200 ease-in-out"
            fill={`${hoveredIcon === 5 ? "#61DAFB" : "#1F2324"}`}
          ...
          <path
            className="transition-colors duration-200 ease-in-out"
            fill={`${hoveredIcon === 5 ? "#1ac9f9" : "#1F2324"}`}
        ...
        >
          <path
            className="transition-colors duration-200 ease-in-out"
            fill={`${hoveredIcon === 6 ? "#F34F29" : "#1F2324"}`}
